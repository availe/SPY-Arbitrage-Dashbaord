...
<FlexTable
  ...
  data={[
    {
      Aspect: "Trading Constraints",
      "Current Approach": "No explicit trading costs, borrow fees, or constraints for short positions",
      "Potential Enhancements": "Reflect bid-ask spreads, short borrow costs, and borrowing availability"
    },
    {
